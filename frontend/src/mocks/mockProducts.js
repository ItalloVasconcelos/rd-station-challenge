const mockProducts = [
  {
    "id": 1,
    "name": "RD Station CRM",
    "description": "Seu processo de vendas organizado e escalável",
    "category": "Vendas",
    "preferences": [
  ...
  },
  {
    ...
    "description": "Automação de Marketing que cabe no bolso",
    "category": "Marketing",
    "preferences": [
  ...
  },
  {
    "id": 3,
    "name": "RD Conversas",
    "description": "Atendimento digital ágil e em um só lugar",
  ...
  },
  {
    "id": 4,
    "name": "RD Mentor AI",
    "description": "Mentoria com AI, para facilitar seus processos.",
